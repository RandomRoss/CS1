...
void usrAnswer::usrSelect(int catLocation, string questionString,int roundNum){
 ...
 if (roundNumber == 3){
    ...
    cout << catagory[catLocation-1] << " for: " << endl // displaying the catagories and displaying the score incrementing by 200 each catagory or pricing selection 
    ...
    // diplaying your balannce anad the ai balance
...
bool usrAnswer::strCmp(string usrStr, string answerString, double accuracy){
    ...
    //percent correct of sting compair 
